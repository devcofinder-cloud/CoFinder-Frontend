  ...
  const sendMessage = (text?: string) => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        ...
        role: "assistant",
        content:
          "Absolutely. I can help you work through that. Once we connect this with your CoFinder profile, I can give you a much more personalized recommendation.",
      };
    ...
    <main className="min-h-screen bg-white text-zinc-950">
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[1500px]">
        ...
        <aside className="hidden w-[250px] shrink-0 border-r border-zinc-100 px-5 py-6 lg:flex lg:flex-col">
          ...
          <div className="mt-auto rounded-2xl bg-zinc-50 p-4">
            ...
            <p className="mt-2 text-[11px] leading-5 text-zinc-400">
              Ask Nova about your profile, startup,
              co-founder search or next move.
            </p>
        ...
        <section className="relative flex min-h-screen min-w-0 flex-1 flex-col">
                ...
                <div className="flex min-h-[calc(100vh-210px)] flex-col">
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="mt-4 max-w-[440px] text-[13px] leading-6 text-zinc-400 sm:text-sm">
                      Think of me as your founder copilot.
                      I can help you find the right co-founder,
                      improve your profile and make smarter startup decisions.
                    </p>
          ...
          <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-white via-white/95 to-transparent px-3 pb-3 pt-12 sm:px-6 sm:pb-5 mb-10">
