...
export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-4 left-1/2 z-50 -translate-x-1/2">
      <nav
        className=" flex h-[62px] w-[360px] items-center justify-between rounded-full border border-gray-200
          bg-white  px-2 shadow-[0_4px_15px_rgba(0,0,0,0.18)] sm:w-[500px] md:h-[64px] ">
        {tabs.map((tab) => {
          const Icon = tab.icon;
